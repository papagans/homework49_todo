...
from webapp.forms import TodoForm, StatusForm, TypeForm
...
class StatusUpdateView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return render(request, 'status_update.html', context={'form': form,  'status': todo.pk})
...
class TypeUpdateView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return render(request, 'type_update.html', context={'form': form,  'type': todo.pk})
